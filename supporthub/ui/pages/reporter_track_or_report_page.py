"""Reporter Track or Report Choice Page"""
...
def create_reporter_track_or_report_page(on_track=None, on_report=None, on_back=None, responsive=None):
    """Page for choosing between tracking an incident or reporting a new one"""
